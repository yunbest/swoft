...
return [
    ...
    'tcp-server'     => [
        'host'               => env('TCP_SERVER_HOST', '0.0.0.0'),
        'port'               => env('TCP_SERVER_PORT', 8099),
        'mode'              => env('TCP_SERVER_MODE', SWOOLE_PROCESS),
        'type'               => env('TCP_SERVER_TYPE', SWOOLE_SOCK_TCP),
        'package_max_length' => env('TCP_SERVER_PACKAGE_MAX_LENGTH', 2048),
        'open_eof_check'     => env('TCP_SERVER_OPEN_EOF_CHECK', false),
    ],
    'http'    => [
